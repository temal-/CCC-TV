...
//  CCC-TV
//
//  Created by Kris Simon on 13/10/15.
...
let version = ((Bundle.main.infoDictionary?["CFBundleShortVersionString"] as AnyObject).description)! as String
...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    func appController(appController: TVApplicationController, evaluateAppJavaScriptInContext jsContext: JSContext)
    {
        ...
        jsContext.setObject(settingsExport, forKeyedSubscript: "settingswrapper" as NSCopying & NSObjectProtocol);
        jsContext.setObject(logsExport, forKeyedSubscript: "Log" as NSCopying & NSObjectProtocol);
        jsContext.setObject(conferenceExporter, forKeyedSubscript: "Conference" as NSCopying & NSObjectProtocol);
    }
    ...
    lazy var applicationCachesDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "de.ausdertechnik.CCC_TV" in the application's caches Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "CCC_TV", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationCachesDirectory.appendingPathComponent("SingleViewCoreData.sqlite")
